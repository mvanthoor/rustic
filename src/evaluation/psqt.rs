...
[
    ...
    W( 33, -3), W(26,  6), W( 42, 10), W( 11,  6), W( 11,  8), W( 40,24), W( 35, 27), W( -2,  3),
    W(  0,-16), W(-9,  8), W(  1, 13), W(-21, 20), W(-20, 14), W(-22,19), W(-15, 10), W(-60, -3),
    W(-25,-25), W(16,-14), W(-27, 13), W(-67, 20), W(-81, 24), W(-58,15), W(-40,  1), W(-62,-15),
    W(  7,-27), W(-2,-10), W(-37,  9), W(-77, 20), W(-79, 23), W(-60,14), W(-23,  2), W(-26,-12),
    W( 12,-32), W(15,-17), W(-13,  4), W(-72, 14), W(-56, 15), W(-28, 5), W( 15,-10), W( 17,-22),
    W( -6,-55), W(44,-40), W( 29,-23), W(-58, -6), W(  8,-20), W(-25,-8), W( 34,-28), W( 28,-47),
];
