...
const QUEEN_MG: PSQT = [
    ...
    -10,   -5,   10,  -10,   20,   10,   -5,  -10,
    -10,   20,   15,   -5,   10,  -75,   -5,  -10,
    -20,  -10,   -5,   -5,  -25,   -5,  -10,  -20,
    -30,  -20,  -10,   75,  -10,  -10,  -20,  -30 
];
...
const KNIGHT_MG: PSQT = [
    ...
    -10,  -5,   25,   40,   40,   25,   -5,  -10,
    -10,  -5,   20,   40,   40,   20,   -5,  -10,
    -10,  -5,   50,    5,    5,   20,   -5,  -10,
    -10,  -5,   -5,   -5,   -5,   -5,   -5,  -10,
    -20,   0,  -10,  -10,  -10,  -10,   -5,  -20
];

#[rustfmt::skip]
const PAWN_MG: PSQT = [
     0,   0,   0,   0,   0,   0,   0,   0,
    15,  15,  30,  50,  50,  15,  15,  15,
    10,  10,  25,  45,  45,  10,  10,  10,
     5,   5,  20,  45,  45,  10,   5,   5,
     5,   5,  15,  40,  75,  10,   5,   5,
     5,   5,  10,  20,  10, -15,   5,   5,
     5,   5,   5, -20, -75,  15,    5,   5,
